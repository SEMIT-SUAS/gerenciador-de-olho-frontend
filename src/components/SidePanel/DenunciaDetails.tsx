            ...
            <div className="space-y-4">
                <div className="flex justify-between items-center">
                    <div className="flex-row">
                        ...
                        <p className="text-sm font-semibold text-yellow-700">{item.categoria.name}</p>
                    ...
                    <>
                        <div className="flex items-center px-4 py-3 justify-between bg-yellow-100 rounded-xl">
                            <div>
                                ...
                                <p className='text-xs font-semibold text-yellow-700'>{acaoVinculada.length > 0 ? acaoVinculada[0].secretaria.name ?? '' : 'Desconhecida'}</p>
                            </div>
