...
export const IndeferirDenunciaView: FC = () => {
  const { denunciaParaIndeferir, cancelIndeferir, confirmIndeferir } =
    useIndeferirDenunciaContext();
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg">
          ...
          <p className="font-bold text-red-900">
            {denunciaParaIndeferir.tipo.name}
          </p>
        ...
        <div className="flex-1 flex flex-col space-y-4">
          ...
          <button
            ...
            className="w-full border-2 border-red-500 text-red-500 text-sm font-semibold py-2 rounded-lg transition hover:bg-red-500 hover:text-white outline-0    "
          >
