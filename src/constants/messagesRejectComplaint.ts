export const mensagensSugeridasParaIndeferirDenuncia = [
  'Ausência de evidências diante do tipo de denúncia enviada.',
  'Falta de informações que possibilitem a análise e investigação.',
  'Devido à natureza da queixa não se enquadrar nos critérios de atuação do órgão/plataforma.',
