    ...
    tipoParaEditar: TipoDenunciaFormValues
    }
    ...
    const formDefaultValues = useMemo(() => {
        ...
        (s) => s.id === Number(tipoParaEditar.secretariaId)
        );

        const categoriaEncontrada = categorias.find(
        (c) => c.id === Number(tipoParaEditar.categoriaId)
        );
    ...
    async function onSubmit(data: TipoDenunciaFormValues) {
        ...
        toast.error(error.message || 'Ocorreu um erro ao criar o tipo de denúncia.');
        } finally {
